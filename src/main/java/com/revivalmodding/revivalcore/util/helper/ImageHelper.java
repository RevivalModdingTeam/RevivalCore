...
public final class ImageHelper {
    ...
    public static void drawColorShape(int x, int y, int w, int h, float red, float green, float blue) {
        GlStateManager.color(1f, 1f, 1f, 1f);
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferBuilder = tessellator.getBuffer();
        bufferBuilder.begin(7, DefaultVertexFormats.POSITION_COLOR);
        bufferBuilder.pos(x, y + h, 0).color(red, green, blue, 1.0F).endVertex();
        bufferBuilder.pos(x + w, y + h, 0).color(red, green, blue, 1.0F).endVertex();
        bufferBuilder.pos(x + w, y, 0).color(red, green, blue, 1.0F).endVertex();
        bufferBuilder.pos(x, y, 0).color(red, green, blue, 1.0F).endVertex();
        tessellator.draw();
    }

    public static void drawColorLine(int x0, int y0, int x1, int y1, float red, float green, float blue, int width) {
        GlStateManager.color(1f, 1f, 1f, 1f);
        GlStateManager.glLineWidth(width);
        Tessellator tessellator = Tessellator.getInstance();
        BufferBuilder bufferBuilder = tessellator.getBuffer();
        bufferBuilder.begin(3, DefaultVertexFormats.POSITION_COLOR);
        bufferBuilder.pos(x0, y0, 0).color(red, green, blue, 1.0F).endVertex();
        bufferBuilder.pos(x1, y1, 0).color(red, green, blue, 1.0F).endVertex();
        tessellator.draw();
    }
